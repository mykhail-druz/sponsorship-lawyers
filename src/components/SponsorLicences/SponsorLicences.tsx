    ...
    <section className={styles.section}>
      ...
      <div className={styles.content}>
        ...
        <p className={`${poppins.className} ${styles.description}`}>
          ...
          your business <br /> meets the requirements, you can apply for one of
          the following categories:
        </p>
        </div>
        <div className={styles.grid__card}>
          <Card
                      title={<h2 className={`${styles.card__title} ${basker.className}`}>Workers</h2>}
            desc={
              <p className={`${styles.card__desc} ${poppins.className}`}>
                    for skilled, long term employment <br /> commonly under the Skilled <br /> Worker route
              </p>
            }
          />
          <Card
                      title={<h2 className={`${styles.card__title} ${basker.className}`}>Temporary <br />workers</h2>}
            desc={
              <p className={`${styles.card__desc} ${poppins.className}`}>
          ...
          />
          <Card
                      title={<h2 className={`${styles.card__title} ${basker.className}`}>Education providers</h2>}
            desc={
              <p className={`${styles.card__desc} ${poppins.className}`}>
                    to sponsor international<br /> students to study
              </p>
            }
          />
        </div>
